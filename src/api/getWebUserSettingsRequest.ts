...
export function getWebUserSettingsRequest(intAccount: number, accountConfig: AccountConfigType): Promise<WebUserSettingType> {
  return new Promise((resolve, reject) => {
    ...
    const uri = `${accountConfig.data.paUrl}${GET_WEB_USER_SETTINGS_PATH}?intAccount=${intAccount}&sessionId=${accountConfig.data.sessionId}`
